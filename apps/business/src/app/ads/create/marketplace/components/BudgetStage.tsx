...
export default function MarketplaceBudgetStage() {
        ...
        <div className="lg:col-span-7 space-y-10">
           ...
           <section className="space-y-4">
              ...
              <div className="flex justify-between text-[8px] font-black text-muted-custom/60 uppercase tracking-widest">
                 <span>Minimum: KES 1,000</span>
                 <span>Growth: KES 150k+</span>
              </div>
           </section>
           ...
           <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                 <StrategyButton 
                   ...
                   desc="Maximize product purchases for your daily budget." 
                   icon={<Zap size={16} />}
                 />
                 <StrategyButton 
                   ...
                   label="Cost per Sale" 
                   desc="Control the exact CPA you pay for each conversion." 
                   icon={<Lock size={16} />}
                 />
              </div>
           </section>
           ...
           <section className="space-y-4">
              ...
              <p className="text-[9px] font-bold text-muted-custom leading-relaxed">
                 {pacing === 'standard' 
                   ? "Consistent product exposure to buyers throughout the day." 
                   : "Capture early-morning and lunch-break impulse buyers."}
              </p>
           </section>

           <section className="space-y-4">
              <label className="text-[9px] font-black uppercase tracking-widest text-muted-custom flex items-center gap-2">
                 <BarChart3 size={12} /> Re-targeting Frequency
              </label>
              <div className="flex items-center gap-4">
                 ...
                 />
                 <p className="text-[10px] font-bold text-muted-custom">maximum touches per shopper per day.</p>
              </div>
           </section>
        </div>
        ...
        <div className="lg:col-span-5">
           <div className="card-surface rounded-2xl border-custom p-6 sticky top-24 space-y-8 bg-black/40">
              <div className="flex justify-between items-start">
                 <div>
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-primary-gold mb-2 font-inter">Commerce Financials</h4>
              ...
              <div className="space-y-6">
                 <div className="flex justify-between items-end border-b border-white/5 pb-4">
                    <div>
                       <p className="text-[18px] font-black text-main font-inter">{Math.floor(budget / 18).toLocaleString()}</p>
                       <p className="text-[9px] font-black uppercase text-muted-custom font-inter">Est. Daily Sales</p>
                    </div>
                    <div className="text-right">
                       <p className="text-[18px] font-black text-main font-inter">{(budget * 15).toLocaleString()}</p>
                       <p className="text-[9px] font-black uppercase text-muted-custom font-inter">Est. Daily Impressions</p>
                    </div>
                 </div>
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                       <span className="text-muted-custom">Inventory Sync</span>
              ...
              <div className="p-4 rounded-xl border border-white/5 bg-white/5">
                 ...
                 <p className="text-[8px] font-bold text-muted-custom mt-2 italic">Covers 18 days of this sales-driven campaign.</p>
              </div>
           </div>
        </div>
      </div>
